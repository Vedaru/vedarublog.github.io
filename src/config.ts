...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "vedaru", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
...
export const footerConfig: FooterConfig = {
	...
	// 也可以直接编辑 src/partials/footer-config.html 文件来添加备案号等自定义内容
	// 注意：若 customHtml 不为空，则使用 customHtml 中的内容；若 customHtml 留空，则使用 footer-config.html 文件中的内容
};
